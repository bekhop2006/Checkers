...
import type { CoachReportResponse } from "@checkers/shared-types";
...
export default function MatchReviewPage() {
  ...
  const [report, setReport] = useState<CoachReportResponse | null>(null);
  ...
  const generate = async () => {
    ...
    try {
      ...
      const json = (await res.json()) as CoachReportResponse;
